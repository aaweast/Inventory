...
public class inventoryList extends JFrame
{
    ...
    //  create table for inventory to display
    public inventoryList(String tableString) 
    {
        ...
        String[] columns = {"sold_by", "name", "storage_type", "quantity", "sku", 
                            "type", "unit_storage_type", "unit_quantity", 
                            "quant_per_unit_quant", "min_quant"};
