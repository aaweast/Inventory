...
public class manViewOrderTrends extends JFrame 
{
    ...
    public manViewOrderTrends(String tableString) 
    {
        ...
        String[] columns = {"Menu ID","Trend Percentage"};
        ...
        this.setTitle("Order Trend View");
